...
- [`maximo-labor-resources`](../maximo-labor-resources/) — labor masters (LABOR, PERSON, CRAFT, LABORCRAFTRATE), qualifications (QUALIFICATION, QUALPERSON), crews (AMCREW, AMCREWLABOR), calendars (CALENDAR, WORKPERIOD), assignments (ASSIGNMENT). Composes with `maximo-pm-planning` for workload-vs-capacity gap analytics.
